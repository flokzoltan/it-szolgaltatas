...
const AppModel = {
  ...
  i18n: {
    hu: {
      ...
      'hero.trust1': '14 nap garancia minden munkára', 'hero.trust2': 'Kiszállás 1–2 napon belül', 'hero.trust3': 'Helyi árak, nem fővárosi',
      ...
      'hero.logFoot1': 'Helyi esetek', 'hero.logFoot2': 'Minden bejegyzés — valós eset', 'hero.common': 'Legtöbben lassú gép vagy wifi miatt írnak.',
      ...
      'svc.eyebrow': 'Szolgáltatások', 'svc.badgeCommon': 'Gyakori', 'svc.badgeRemote': 'Távolról', 'svc.heading': 'Amiben segíteni tudok',
      'svc.sub': 'Minden tételnél megtalálod, miről ismerheted fel, hogy épp ez a problémád — és mennyibe kerül a megoldás. Nincs meglepetés.', 'svc.hint': 'Leggyakoribb: wifi, lassú gép, vírusirtás.', 'svc.toggleMorePrefix': 'További', 'svc.toggleMoreSuffix': 'szolgáltatás', 'svc.toggleLess': 'Kevesebb mutatása', 'mobile.call': 'Hívás', 'mobile.msg': 'Messenger', 'price.whyLabel': 'Tudnivaló',
      ...
      'price.why': 'Óradíj csak akkor, ha a hiba előre nem mérhető. A wifi, telepítés, nyomtató és hasonló munkák fix áron szerepelnek a listában.',
      ...
      'why.item4': '<b>Helyi, vidéki árazás</b><span>Nem a fővárosi szervizek díjszabása — a környékre szabva.</span>',
      ...
      'faq.q1': 'Mennyi idő alatt érsz ki hozzám?', 'faq.a1': 'A környéken jellemzően 1–2 napon belül, sürgős esetben akár még aznap.',
      ...
      'footer.desc': 'Számítógépes és hálózati segítség házhoz.',
      'footer.copy': '© 2026', 'footer.area': 'Ipolyság · Šahy', 'footer.tags': 'Készpénzes fizetés · 14 nap garancia',
    ...
    sk: {
      ...
      'hero.trust1': '14 dní záruka na každú prácu', 'hero.trust2': 'Príchod do 1–2 dní', 'hero.trust3': 'Miestne ceny, nie bratislavské',
      ...
      'hero.logFoot1': 'Miestne prípady', 'hero.logFoot2': 'Každý záznam — reálny prípad', 'hero.common': 'Najčastejšie píšu kvôli pomalému PC alebo wifi.',
      ...
      'svc.eyebrow': 'Služby', 'svc.badgeCommon': 'Časté', 'svc.badgeRemote': 'Na diaľku', 'svc.badgeCommon': 'Časté', 'svc.heading': 'V čom viem pomôcť',
      'svc.sub': 'Pri každej položke nájdete, podľa čoho spoznáte, že práve toto je váš problém — a koľko bude stáť riešenie. Žiadne prekvapenia.', 'svc.hint': 'Najčastejšie: wifi, pomalý PC, vírusy.', 'svc.toggleMorePrefix': 'Ďalšie', 'svc.toggleMoreSuffix': 'služby', 'svc.toggleLess': 'Zobraziť menej', 'mobile.call': 'Volanie', 'mobile.msg': 'Messenger', 'price.whyLabel': 'Dôležité',
      ...
      'svc6.title': 'Zrýchlenie výmenou za SSD', 'svc6.desc': 'Namiesto pomalého disku dám SSD. Programy a súbory ostanú — štart a otváranie budú citeľne rýchlejšie.', 'svc6.symptom': '<b>Podľa čoho to spoznáte:</b> počítač minúty štartuje alebo otvára programy — kedysi to tak nebolo.', 'svc6.price': '20–30 €',
      ...
      'price.why': 'Hodinová sadzba len vtedy, keď poruchu vopred nevieme odhadnúť. Wifi, inštalácia, tlačiareň a podobné práce majú pevnú cenu v zozname.',
      ...
      'why.item4': '<b>Miestne, regionálne ceny</b><span>Nie ceny veľkomestských servisov — nastavené pre okolie.</span>',
      ...
      'faq.q1': 'Za ako dlho prídete?', 'faq.a1': 'V okolí zvyčajne do 1–2 dní, v naliehavom prípade aj v ten istý deň.',
      ...
      'footer.desc': 'Počítačová a sieťová pomoc s výjazdom.',
      'footer.copy': '© 2026', 'footer.area': 'Šahy', 'footer.tags': 'Platba v hotovosti · 14 dní záruka',

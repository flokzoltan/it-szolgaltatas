...
const AppModel = {
  ...
  i18n: {
    hu: {
      ...
      'svc.sub': 'Minden tételnél megtalálod, miről ismerheted fel, hogy épp ez a problémád — és mennyibe kerül a megoldás. Nincs meglepetés.', 'svc.hint': 'Leggyakoribb: wifi, lassú gép, vírusirtás.',
    ...
    sk: {
      ...
      'svc.eyebrow': 'Služby', 'svc.badgeCommon': 'Časté', 'svc.badgeRemote': 'Na diaľku', 'svc.heading': 'V čom viem pomôcť',
      'svc.sub': 'Pri každej položke nájdete, podľa čoho spoznáte, že práve toto je váš problém — a koľko bude stáť riešenie. Žiadne prekvapenia.', 'svc.hint': 'Najčastejšie: wifi, pomalý PC, vírusy.',
